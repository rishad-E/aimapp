...
class EducatorStatusBottomsheet extends StatelessWidget {
  const EducatorStatusBottomsheet({super.key});

  @override
  Widget build(BuildContext context) {
    final controller = Get.find<EducatorPersonalDetailController>();
    return Padding(
