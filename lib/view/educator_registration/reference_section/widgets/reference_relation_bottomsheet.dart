                  ...
                  return ListTile(
                        ...
                        if (value != null && value) {
                          if (reference == '1') {
                            ...
                            controller.otherRelation1.value =
                                relationList[index];
                            log(controller.otherRelation1.value);
                            ...
                            controller.otherRelation2.value =
                                relationList[index];
                            log(controller.otherRelation2.value);
                            controller.checkAlFields();
                            controller.update(['edu-referenceInfo']);
                          }
                          Get.back();
                    ...
                    onTap: () {
                      if (reference == '1') {
                        controller.relationController1.text =
                            relationList[index];
                        controller.otherRelation1.value = relationList[index];
                        log(controller.otherRelation1.value);
                        controller.checkAlFields();
                        controller.update(['edu-referenceInfo']);
                      } else {
                        controller.relationController2.text =
                            relationList[index];
                        controller.otherRelation2.value = relationList[index];
                        log(controller.otherRelation2.value);
                        controller.checkAlFields();
                        controller.update(['edu-referenceInfo']);
                      }
