...
class AimcetReviewData {
    List<AlltestReview>? alltestReview;
    String? averageRating;
    int? totalReviews;
    List<String>? starPercentages;
    ...
    factory AimcetReviewData.fromJson(Map<String, dynamic> json) => AimcetReviewData(
        alltestReview: json["AlltestReview"] == null ? [] : List<AlltestReview>.from(json["AlltestReview"]!.map((x) => AlltestReview.fromJson(x))),
        averageRating: json["averageRating"],
        totalReviews: json["totalReviews"],
        starPercentages: json["starPercentages"] == null ? [] : List<String>.from(json["starPercentages"]!.map((x) => x)),
    );

    Map<String, dynamic> toJson() => {
        "AlltestReview": alltestReview == null ? [] : List<dynamic>.from(alltestReview!.map((x) => x.toJson())),
        "averageRating": averageRating,
        "totalReviews": totalReviews,
        "starPercentages": starPercentages == null ? [] : List<dynamic>.from(starPercentages!.map((x) => x)),
    };
}
